...
namespace Population\Manipule\Managers\Post;
 ...
 * Class PostValidator.
 *
 * @package Population\Manipule\Managers\Post
 */
class PostValidator
{
    /**
    ...
    {
        $validUserIdRule = Rule::exists(Tables::TABLE_USERS, 'id');
        $validPhotoIdRule = Rule::exists(Tables::TABLE_PHOTOS, 'id');
        $uniquePhotoIdRule = Rule::unique(Tables::TABLE_POSTS_PHOTOS, 'photo_id');
    ...
    {
        $validPhotoIdRule = Rule::exists(Tables::TABLE_PHOTOS, 'id');
        $uniquePhotoIdRule = Rule::unique(Tables::TABLE_POSTS_PHOTOS, 'photo_id')->ignore(optional($post->photo)->id, 'photo_id');
