...
class Sitio extends Base
{
    ...
    {
        return $this->morphedByMany(config('sitec.core.models.user', \App\Models\User::class), 'sitioable');
    }
    ...
    {
        return $this->morphedByMany('Population\Models\Entytys\Digital\Midia\Video', 'sitioable');
    }
}
